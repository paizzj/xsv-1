...
static UniValue fchtoxsv(const Config &config,
                                const JSONRPCRequest &request) {
    if (request.fHelp || request.params.size() != 1) {
        throw std::runtime_error(
            "fchtoxsv \"address\"\n"
            "\nReturn xsv address about the given fch address.\n"
            "\nArguments:\n"
            "1. \"address\"     (string, required) The fch address to "
            "validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is "
            "valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"address\", (string) The xsv address "
            "validated\n"
            "  \"scriptPubKey\" : \"hex\",       (string) The hex encoded "
            "scriptPubKey generated by the address\n"
            "}\n"
            "\nExamples:\n" +
            HelpExampleCli("fchtoxsv",
                           "\"F9A9TgNE2ixYhQmEnB15BNYcEuCvZvzqxT\"") +
            HelpExampleRpc("fchtoxsv",
                           "\"F9A9TgNE2ixYhQmEnB15BNYcEuCvZvzqxT\""));
    }
...
static const CRPCCommand commands[] = {
    ...
    { "util",               "fchtoxsv",               fchtoxsv,               true,  {"address"} }, /* uses wallet if enabled */
